...
export default function EditPostPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      const foundPost = adminPosts.getById(postId)
      if (!foundPost) {
      ...
      setFormData({
        ...
        html: foundPost.html,
        feature_image: foundPost.feature_image || "",
        primary_author_id: foundPost.primary_author.id,
        primary_tag_id: foundPost.primary_tag?.id || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      adminPosts.update(postId, updates)
      router.push("/admin/posts")
    } catch (error) {
