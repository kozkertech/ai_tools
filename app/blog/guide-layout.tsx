...
export default function GuideLayout({ children, showToc = true }: GuideLayoutProps) {
      ...
      <div className="hidden xl:block w-64 flex-shrink-0">
        <div className="sticky top-24">
          <div className="border-l-2 border-gray-200 dark:border-gray-700 pl-4">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-4">On this page</h3>
            <nav className="space-y-2">
              {toc.map((item) => (
                <button
                  ...
                  className={cn(
                    "block w-full text-left text-sm transition-all duration-200 hover:text-gray-900 dark:hover:text-gray-100 py-1",
                    item.level === 1 ? "font-medium" : "font-normal pl-4 text-xs",
                    activeId === item.id
                      ? "text-primary font-semibold border-l-2 border-primary -ml-[1px] pl-3"
