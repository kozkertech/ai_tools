...
import { getCaseStudy, getCaseStudies } from "@/lib/ghost"
...
export default async function CaseStudyPage({ params }: { params: { slug: string } }) {
  try {
    ...
    console.error("Error rendering case study page:", error)
    return (
      <div className="container py-8 md:py-12">
        ...
        <div className="mx-auto max-w-3xl text-center py-12">
          <h2 className="text-xl font-medium">Error loading case study</h2>
          <p className="text-muted-foreground mt-2">
            There was an error loading this case study. Please check your Ghost CMS configuration.
          </p>
        </div>
      </div>
    )
