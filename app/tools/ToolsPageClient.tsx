...
const tools = [
  ...
  },
  {
    ...
    description: "Write compelling job descriptions that attract top talent with clear expectations.",
    icon: UserPlus,
    href: "/tools/job-description-writer",
    status: "unAvailable",
    category: "Business",
    features: ["Talent attraction", "Clear expectations", "Industry standards"],
  },
  {
