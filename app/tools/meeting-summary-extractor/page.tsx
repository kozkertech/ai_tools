  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "success",
          text: "Meeting transcript processed successfully!",
          data: responseData,
        })
    ...
    <div className="min-h-screen bg-gradient-to-r from-orange-50 to-orange-100 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2 font-poppins">Meeting Summary Extractor</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-white shadow-xl border-0">
            <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-t-lg">
              <CardTitle className="text-2xl text-gray-900 font-poppins">Submit Your Meeting Transcript</CardTitle>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="border-gray-200 focus:border-orange-500 focus:ring-orange-500 font-inter"
                ...
                {/* Transcript Field */}
                <div className="space-y-2">
                  <Label htmlFor="transcript" className="text-gray-900 font-medium font-inter">
                    Meeting Transcript
                  </Label>
                  <Textarea
                    id="transcript"
                    ...
                    required
                    rows={8}
                    className="border-gray-200 focus:border-orange-500 focus:ring-orange-500 resize-none font-inter"
          ...
          <Card className="bg-white shadow-xl border-0">
            <CardHeader className="bg-gray-50 rounded-t-lg">
              <CardTitle className="text-2xl text-gray-900 font-poppins flex items-center">
              ...
              {message?.type === "success" && message.data?.output ? (
                <div className="animate-fade-in">
                  <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    <div
                      className="prose prose-gray max-w-none font-inter text-gray-600 leading-relaxed"
                      dangerouslySetInnerHTML={{
                        __html: parseMarkdown(message.data.output),
                      }}
                      style={{
                        fontSize: "14px",
                        lineHeight: "1.6",
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 font-inter">Submit a meeting transcript to see the summary here</p>
                </div>
              )}
            </CardContent>
          </Card>
